...
<table width="100%" border="0" cellpadding='2' cellspacing="2" align="center" bgcolor="#ffffff" style="padding-top:4px;">
	<tbody>
		<tr>
			{{-- logo --}}
			<td><img src="{{ asset(''.settings()->get('app_logo')) }}" alt="Logo" width="50" height="50"></td>
			<td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: bottom; text-align: center;">
				<strong style="font-size:16px;">{{ settings('app_name') }}</strong>
				<br>{{ settings('app_address') }}
			</td>
		</tr>
		<tr>
			<td height="2" colspan="2" style="border-bottom:1px solid #e4e4e4 "></td>
		</tr>
	</tbody>
</table>
...
<div style="text-align: center;">
	<img src="{{ asset(''.settings()->get('app_stempel')) }}" alt="Stempel Lunas" width="150" height="150">
</div>
<!-- /Stempel Lunas -->
