...
<section class="content-header">
    <h1>
        Kategori Layanan
        <small>Tambah Kategori Layanan</small>
    </h1>
</section>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Nama Kategori Layanan</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="harga" class="col-sm-2 control-label">Harga / Bulan</label>
                        <div class="col-sm-10">
